...
- Split the exporter into focused reader, layout, rendering, reporting, and per-sheet modules without changing migration behavior.
- Add a production macOS icon for direct and App Store builds.
